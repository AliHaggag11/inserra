              ...
              <thead className="bg-primary text-white">
                <tr>
                  ...
                  {specifications.map((spec, index) => (
                    <th key={index} className="px-6 py-4 text-left">{spec.name}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {Object.keys(specifications[0].specs).map((key, index) => (
                  <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : ''}>
                    ...
                    {specifications.map((spec, specIndex) => (
                      <td key={specIndex} className="px-6 py-4">{spec.specs[key]}</td>
                    ))}
                  </tr>
                ))}
              </tbody>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden bg-gray-200">
                <img
                  src="/path/to/steam-flow-image.jpg"
                  alt="Steam Flow Technology"
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    e.target.src = 'https://via.placeholder.com/800x450?text=Steam+Flow+Technology';
                  }}
                />
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden bg-gray-200">
                <img
                  src="/path/to/machine-overview.jpg"
                  alt="Machine Overview"
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    e.target.src = 'https://via.placeholder.com/800x450?text=Machine+Overview';
                  }}
                />
              </div>
            </motion.div>
