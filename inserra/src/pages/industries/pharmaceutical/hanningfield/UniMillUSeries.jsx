...
const UniMillUSeries = () => {
  ...
  const specifications = [
    {
      model: "Uni Mill M05-U",
      throughput: "200 kgs/hr (425 lbs/hr)",
    ...
    {
      model: "Uni Mill M10-U",
      throughput: "400 kgs/hr (850 lbs/hr)",
    ...
    {
      model: "Uni Mill M20-U",
      throughput: "2000 kgs/hr (4250 lbs/hr)",
    ...
    {
      model: "Uni Mill M30-U",
      throughput: "4000 kgs/hr (8800 lbs/hr)",
      screenDiameter: "306mm (12\")",
      motor: "7.5 kW (10 HP)",
      weight: "400 kgs (880 lbs)",
      speed: "960 RPM"
    }
  ];
  ...
  const features = [
    ...
    {
      title: "No Metal-to-Metal Contact",
      description: "Designed with an optimal, spacer-less gap (to avoid metal-to-metal contact)",
      icon: Wrench
    },
    {
      title: "Easy-Clean GMP Design",
      description: "Optional features include detachable millhead for autoclave or CIP/WIP",
      icon: Cog
    }
  ];
      ...
      <div className="bg-gradient-to-br from-primary to-primary-dark text-white py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl font-bold mb-6">Uni-Mill U-Series</h1>
              <div className="w-24 h-1 bg-white/30 mb-6"></div>
              <p className="text-2xl text-blue-100 mb-6">
                Industry standard under-driven conical mill design for optimal particle size reduction
              </p>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Advanced milling technology designed for pharmaceutical applications, featuring precise particle size control and GMP-compliant construction.
              </p>
            ...
            >
              <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden bg-white/10 backdrop-blur-sm p-4">
                <img
                  src="/images/hanningfield/conical under.jpg"
                  alt="Uni-Mill U-Series Machine"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="mt-6 text-gray-600 max-w-2xl mx-auto">
                Comprehensive specifications for all Uni-Mill U-Series models, designed to meet various production requirements
              </p>
            </div>
              ...
              <table className="min-w-full">
                <thead className="bg-gradient-to-r from-primary to-primary-dark text-white">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Max Throughput</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Screen Diameter</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Standard Motor</th>
