      ...
      <div className="bg-gradient-to-br from-primary to-primary-dark text-white py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl font-bold mb-6">Intermediate Bulk Containers (IBCs)</h1>
              <div className="w-24 h-1 bg-white/30 mb-6"></div>
              <p className="text-2xl text-blue-100 mb-6">
                Advanced storage and handling solutions for pharmaceutical applications
              </p>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Stainless steel IBCs designed for safe and contained transport, storage and handling of materials.
              </p>
            ...
            >
              <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden bg-white/10 backdrop-blur-sm p-4">
                <img
                  src="/images/hanningfield/1500_Litre_IBC-460x308.jpg"
                  alt="IBC System"
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose max-w-none">
              ...
              <h3 className="text-xl font-semibold mb-4">Customise Your IBC</h3>
              <p className="text-gray-600 mb-6">
