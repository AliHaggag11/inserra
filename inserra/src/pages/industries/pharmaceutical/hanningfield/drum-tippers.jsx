...
const DrumTippers = () => {
  ...
  const keyFeatures = [
    "Eliminate manual processes and reduce operator strain",
    "Repeatable positioning for high integrity applications (e.g. docking to inflatable seal on isolator)"
  ];
  ...
  const features = [
    ...
    {
      title: "Multi-Position Heights",
      description: "Multi-position tipping heights available for process flexibility",
      icon: Settings
    },
    {
      title: "ATEX / Ex-proof",
      ...
      <div className="bg-gradient-to-br from-primary to-primary-dark text-white py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl font-bold mb-6">Drum Tippers</h1>
              <div className="w-24 h-1 bg-white/30 mb-6"></div>
              <p className="text-2xl text-blue-100 mb-6">
                Advanced drum handling systems for pharmaceutical applications
              </p>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Designed for safe and efficient drum handling with repeatable positioning capabilities.
              </p>
            ...
            >
              <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden bg-white/10 backdrop-blur-sm p-4">
                <img
                  src="/images/hanningfield/Drum_Tipper_Image_Manual_Tip_1-460x308.jpg"
                  alt="Drum Tipper System"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                Hanningfield Drum Tippers are perfect for manoeuvring and positioning drums. Whether docking or simply inverting, the drum tipper will automate the process delivering a safe, accurate and repeatable action. The unit can be configured to adopt any drum size or type – and can be supplied with outlet chute or cone/valve if required.
              </p>
              
              <p className="text-gray-600 mb-6">
                Manufactured in stainless steel and designed to conform to the GMP requirements of the pharmaceutical, food and allied industries. Drum Tippers are available in various executions including fixed base or mobile trolley.
              </p>
